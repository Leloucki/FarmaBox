              ...
              <div class="card h-100 shadow-lg">
                <div class="card-body">
                  <div class="text-center p-3">
                    ...
                    <br><br>
                    <span class="h2">R$59,99</span>/mês
                    <br><br>
                  </div>
                ...
                <div class="card-body text-center">
                  <a href="{{url('/assinatura/cadastro/1')}}">
              ...
              <div class="card h-100 shadow-lg">
                <div class="card-body">
                  <div class="text-center p-3">
                    ...
                    <small>Individual</small>
                    <br><br>
                    <span class="h2">R$19,99</span> + produtos /mês  
                    <br><br>
                  </div>
                ...
                <div class="card-body text-center">
                  <a href="{{url('/assinatura/cadastro/2')}}">
                  <button class="btn btn-outline-primary btn-lg" style="border-radius:30px">Assinar</button>
                  </a> 
                </div>
              </div>
            </div>
